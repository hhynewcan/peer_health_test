...
// The result page of "Contact: Student Central or Student Faculty Advisors"
class ContactStudentCentralOrStudentFacultyAdvisors extends StatelessWidget {
  @override
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                // The hyperlink to Student Central
                InkWell(
                    onTap: () => launchUrl(Uri.parse("https://students.usask.ca/student-central.php"), mode: LaunchMode.externalApplication),
                    child: RichText(
                      textAlign: TextAlign.center,
                      text: const TextSpan(
                          text: "Student Central",
                          style: TextStyle(
                ...
                // The hyperlink to Student Faculty Advisors
                InkWell(
                    onTap: () => launchUrl(Uri.parse("https://students.usask.ca/academics/advisors.php"), mode: LaunchMode.externalApplication),
                    child: RichText(
                      textAlign: TextAlign.center,
                      text: const TextSpan(
                          text: "Student Faculty Advisors",
                          style: TextStyle(
                            decoration: TextDecoration.underline,
                            fontSize: 28,
                            color: Colors.blue,
