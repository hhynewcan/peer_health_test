...
// The result page of "Contact: Aboriginal Student's Centre"
class ContactAboriginalStudentsCentre extends StatelessWidget {
  @override
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                //The hyperlink of Aboriginal Student's Centre
                InkWell(
                    onTap: () => launchUrl(Uri.parse("https://students.usask.ca/indigenous/asc.php"), mode: LaunchMode.externalApplication),
                    child: RichText(
                      textAlign: TextAlign.center,
                      text: const TextSpan(
                          text: "Aboriginal Student's Centre",
                          style: TextStyle(
