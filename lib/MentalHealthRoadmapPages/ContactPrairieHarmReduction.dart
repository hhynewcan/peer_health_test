...
// The result page of "Contact: Prairie Harm Reduction"
class ContactPrairieHarmReduction extends StatelessWidget {
  @override
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                // The hyperlink to Prairie Harm Reduction
                InkWell(
                    onTap: () => launchUrl(Uri.parse("https://prairiehr.ca/"), mode: LaunchMode.externalApplication),
                    child: RichText(
                      textAlign: TextAlign.center,
                      text: const TextSpan(
                          text: "Prairie Harm Reduction",
                          style: TextStyle(
