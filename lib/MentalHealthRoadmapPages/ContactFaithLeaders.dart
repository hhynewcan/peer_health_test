...
// The result page of "Contact: Faith Leaders"
class ContactFaithLeaders extends StatelessWidget {
  @override
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                // The Faith Leaders hyperlink
                InkWell(
                    onTap: () => launchUrl(Uri.parse("https://wellness.usask.ca/faithleaders"), mode: LaunchMode.externalApplication),
                    child: RichText(
                      textAlign: TextAlign.center,
                      text: const TextSpan(
                          text: "Faith Leaders",
