...
// The result page of "Contact: Access and Equity Services"
class ContactAccessAndEquityServices extends StatelessWidget {
  @override
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                // The hyperlink to Access and Equity Services
                InkWell(
                    onTap: () => launchUrl(Uri.parse("https://students.usask.ca/health/centres/access-equity-services.php"), mode: LaunchMode.externalApplication),
                    child: RichText(
                      textAlign: TextAlign.center,
                      text: const TextSpan(
                          text: "Access and Equity Services",
                          style: TextStyle(
