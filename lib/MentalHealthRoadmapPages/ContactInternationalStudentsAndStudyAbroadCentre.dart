...
class ContactInternationalStudentsAndStudyAbroadCentre extends StatelessWidget {
  @override
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                // The hyperlink to International Students and Study Abroad Centre
                InkWell(
                    onTap: () => launchUrl(Uri.parse("https://students.usask.ca/international/issac.php"), mode: LaunchMode.externalApplication),
                    child: RichText(
                      textAlign: TextAlign.center,
                      text: const TextSpan(
                          text: "International Students and Study Abroad Centre",
                          style: TextStyle(
